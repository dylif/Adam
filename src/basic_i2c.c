...
int i2c_read_reg8(int fd, int8_t reg, int8_t *buf)
{
...
int i2c_write_reg8(int fd, int8_t reg, int8_t data)
{
	int8_t buf[2];
...
int i2c_read_reg16(int fd, int8_t reg, int16_t *buf)
{
	int reg_sz = sizeof(reg);
	int buf_sz = sizeof(*buf);
...
int i2c_write_reg16(int fd, int8_t reg, int16_t data)
{
	int8_t buf[3];
	int sz = sizeof(reg) + sizeof(data);
